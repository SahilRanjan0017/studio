        ...
        {loadingData ? ( 
          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="w-[60px] text-center text-xs font-semibold text-foreground px-2">Rank</TableHead>
                  ...
                  <TableHead className="text-center text-xs font-semibold text-foreground px-2">Deals</TableHead>
                  <TableHead className="text-center text-xs font-semibold text-foreground px-2">Rev (₹ Lacs)</TableHead>
                  <TableHead className="text-right text-xs font-semibold text-foreground px-2">Points</TableHead>
