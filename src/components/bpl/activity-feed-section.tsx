...
const activityData = [
  { 
    ...
    text: <><span className="font-semibold">Manikandan</span> achieved <span className="font-semibold text-primary">Milestone 3</span> on CRN00123.</>, 
    time: "2 hours ago", runsChange: 6
  },
  { 
    ...
    time: "5 hours ago", runsChange: -4
  },
  { 
    icon: <UserPlus size={20} />, iconBgColor: "bg-secondary", 
    text: <><span className="font-semibold"></span>Sameer assigned to new project <span className="font-semibold text-primary">CRN00567</span>.</>, 
    time: "1 day ago" 
  },
  { 
    icon: <TrendingUp size={20} />, iconBgColor: "bg-custom-green", 
    text: <><span className="font-semibold">Sai Ram D</span> completed project <span className="font-semibold text-primary">CRN00098</span> ahead of schedule.</>, 
    time: "2 days ago", runsChange: 5
  },
];
